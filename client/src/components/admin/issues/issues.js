...
class issuesList extends React.Component {
    ...
    fecth(){
        ...
        if(this.props.auth.role === 'admin'){
            axios
            .get(`${API_ROOT}/admin/issues/`, { headers: {"x-access-token" : `${this.props.auth.token}`} })
            .then(res => {
...
editModal(){
        if(this.state.selectedRow === null){
            ...
            this.props.history.push(`/admin/issues/${this.state.selectedRow}`)
    ...
    delModal(){
        if(this.state.selectedRow === null){
            ...
            axios
                .delete(`${API_ROOT}/admin/issues/${this.state.selectedRow}`, { headers: {"x-access-token" : `${this.props.auth.token}`} })
                .then(res => {
                    this.setState(() => ({
                    addHandle: false,
                    selectedRow: null
    ...
    render() {
        ...
        return <div className = "container"><NavbarOut/>
                <div className="wrap">
                    <div className="header">จัดการข้อร้องเรียน
