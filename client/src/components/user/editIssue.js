...
import schema from '../../containers/formSchema/userIssueEdit';
...
class UserEditIssue extends Component {
    ...
    componentDidMount(){
        ...
        if(this.props.auth.role === 'user'){
          axios
              .get(`${API_ROOT}/issues/${id}`, { headers: {"x-access-token" : `${this.props.auth.token}`} })
              .then(res => {
                this.setState({
                  ...
                  console.log('file naja eiei', JSON.parse(JSON.stringify(file[0])));
    ...
    editModal(event){
        ...
        const id = this.props.match.params.id;
            if(event.formData.file[0].files === undefined){
                console.log('file is not update')
                event.formData.file[0] = JSON.parse(JSON.stringify(file[0]))
            }
            else{
                console.log('file is updated')
            }
            axios
            .put(`${API_ROOT}/issues/${id}`,{
                            ...
                            <div className='col-10'>
                                ...
                                <Form
                                    ...
                                    > 
                                        ...
                                        <div>
                                        <Link to={`/user/issues/${this.state.param}`}>
...
export default connect(mapStateToProps, {  })(UserEditIssue);